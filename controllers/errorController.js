...
const handleCastErrorDB = (err) => {
  const message = `Invalid ${err.path} on ${err.value}`;
...
const handleJWTError = () =>
  new AppError('Invalid token, Please log in agian', 404);

const handleJTWExpiredError = () =>
  new AppError('Your token has expired!, Please log in agian', 404);
